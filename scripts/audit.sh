...
for page in app/page.tsx "app/[locale]/pricing/page.tsx" "app/[locale]/stack/page.tsx" "app/[locale]/privacy/page.tsx" "app/[locale]/terms/page.tsx" "app/[locale]/disclaimer/page.tsx"; do
  if [ -f "$page" ]; then
...
# OG tags
if grep -q "openGraph" "app/[locale]/layout.tsx" 2>/dev/null || grep -q "openGraph" app/layout.tsx 2>/dev/null; then
...
# Twitter cards
if grep -q "twitter" "app/[locale]/layout.tsx" 2>/dev/null || grep -q "twitter" app/layout.tsx 2>/dev/null; then
...
if grep -q 'lang=' "app/[locale]/layout.tsx" 2>/dev/null || grep -q 'lang="en' app/layout.tsx 2>/dev/null; then
  log_pass "HTML lang attribute set (i18n-aware)"
else
