...
for page in app/page.tsx "app/[locale]/page.tsx" "app/[locale]/pricing/page.tsx" "app/[locale]/stack/page.tsx" "app/[locale]/privacy/page.tsx" "app/[locale]/terms/page.tsx" "app/[locale]/disclaimer/page.tsx"; do
  if [ -f "$page" ]; then
...
# OG tags (check both root and locale layout)
if grep -q "openGraph" app/layout.tsx app/\[locale\]/layout.tsx 2>/dev/null; then
  log_pass "OpenGraph meta tags configured"
else
  log_fail "OpenGraph meta tags MISSING"
fi

# Twitter cards (check both root and locale layout)
if grep -q "twitter" app/layout.tsx app/\[locale\]/layout.tsx 2>/dev/null; then
