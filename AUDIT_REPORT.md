...
Generated: Fri May  8 06:39:50 UTC 2026
...
- WARN: dangerouslySetInnerHTML used (potential XSS): components/Terminal.tsx:3754:          <div key={i} dangerouslySetInnerHTML={{ __html: ansiToHtml(line) }} />
...
- WARN: Potentially misleading status '"active"' found in pages
  app/[locale]/page.tsx:294:  return <div ref={ref} className={`cursor-spotlight ${active ? "active" : ""}`} />;
  app/[locale]/page.tsx:1009:  { domain: "coreyai.ai", role: "Personal AI brand", status: "active" },
  app/[locale]/page.tsx:1010:  { domain: "zynthio.ai", role: "Parent brand / trading engine", status: "active" },
