...
Generated: Thu Apr 30 04:49:53 UTC 2026
...
- WARN: dangerouslySetInnerHTML used (potential XSS): components/Terminal.tsx:2424:          <div key={i} dangerouslySetInnerHTML={{ __html: ansiToHtml(line) }} />
...
- WARN: Potentially misleading status '"active"' found in pages
  app/page.tsx:609:  { domain: "coreyai.ai", role: "Personal AI brand", status: "active" },
  app/page.tsx:610:  { domain: "zynthio.ai", role: "Parent brand / trading engine", status: "active" },
  app/page.tsx:611:  { domain: "coreintent.dev", role: "Dev hub / this site", status: "active" },
