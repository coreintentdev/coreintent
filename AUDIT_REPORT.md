...
Generated: Thu May  7 06:19:18 UTC 2026
...
- WARN: dangerouslySetInnerHTML used (potential XSS): components/Terminal.tsx:3653:          <div key={i} dangerouslySetInnerHTML={{ __html: ansiToHtml(line) }} />
...
- WARN: Potentially misleading status '"active"' found in pages
  app/page.tsx:384:  return <div ref={ref} className={`cursor-spotlight ${active ? "active" : ""}`} />;
  app/page.tsx:1098:  { domain: "coreyai.ai", role: "Personal AI brand", status: "active" },
  app/page.tsx:1099:  { domain: "zynthio.ai", role: "Parent brand / trading engine", status: "active" },
