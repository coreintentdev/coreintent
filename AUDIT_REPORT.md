...
Generated: Fri May  1 04:49:44 UTC 2026
...
- WARN: dangerouslySetInnerHTML used (potential XSS): components/Terminal.tsx:2841:          <div key={i} dangerouslySetInnerHTML={{ __html: ansiToHtml(line) }} />
...
- PASS: Locale-aware links used in 7 files
...
- PASS: HTML lang attribute set (via i18n locale layout)
...
**Audit Score: 97%** (47/48 checks passed)
