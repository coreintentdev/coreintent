...
Generated: Tue May  5 06:35:14 UTC 2026
...
- WARN: dangerouslySetInnerHTML used (potential XSS): components/Terminal.tsx:3292:          <div key={i} dangerouslySetInnerHTML={{ __html: ansiToHtml(line) }} />
...
- PASS: next/link used in 7 files
...
**Audit Score: 98%** (51/52 checks passed)
