...
Generated: Wed Apr 29 06:37:04 UTC 2026
...
- WARN: dangerouslySetInnerHTML used (potential XSS): components/Terminal.tsx:2603:          <div key={i} dangerouslySetInnerHTML={{ __html: ansiToHtml(line) }} />
...
- WARN: Potentially misleading status '"active"' found in pages
  app/page.tsx:642:  { domain: "coreyai.ai", role: "Personal AI brand", status: "active" },
  app/page.tsx:643:  { domain: "zynthio.ai", role: "Parent brand / trading engine", status: "active" },
  app/page.tsx:644:  { domain: "coreintent.dev", role: "Dev hub / this site", status: "active" },
