...
Generated: Wed Apr 29 04:54:14 UTC 2026

## 1. Build
- PASS: npm run build succeeds
- INFO: Routes found: 24
...
- WARN: dangerouslySetInnerHTML used (potential XSS): components/Terminal.tsx:2141:          <div key={i} dangerouslySetInnerHTML={{ __html: ansiToHtml(line) }} />
...
- WARN: Potentially misleading status '"active"' found in pages
  app/[locale]/page.tsx:346:  { domain: "coreyai.ai", role: "Personal AI brand", status: "active" },
  app/[locale]/page.tsx:347:  { domain: "zynthio.ai", role: "Parent brand / trading engine", status: "active" },
  app/[locale]/page.tsx:348:  { domain: "coreintent.dev", role: "Dev hub / this site", status: "active" },
...
- PASS: HTML lang attribute set (dynamic i18n)
