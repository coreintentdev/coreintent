...
Generated: Thu Apr 16 10:41:33 UTC 2026
...
- WARN: dangerouslySetInnerHTML used (potential XSS): components/Terminal.tsx:1139:          <div key={i} dangerouslySetInnerHTML={{ __html: ansiToHtml(line) }} />
...
- WARN: Potentially misleading status '"active"' found in pages
  app/page.tsx:69:  { domain: "coreyai.ai", role: "Personal AI brand", status: "active" },
  app/page.tsx:70:  { domain: "zynthio.ai", role: "Parent brand / trading engine", status: "active" },
  app/page.tsx:71:  { domain: "coreintent.dev", role: "Dev hub / this site", status: "active" },
