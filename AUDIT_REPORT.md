...
- WARN: dangerouslySetInnerHTML used (potential XSS): components/Terminal.tsx:2159:          <div key={i} dangerouslySetInnerHTML={{ __html: ansiToHtml(line) }} />
...
- WARN: Potentially misleading status '"active"' found in pages
  app/[locale]/page.tsx:323:  { domain: "coreyai.ai", role: "Personal AI brand", status: "active" },
  app/[locale]/page.tsx:324:  { domain: "zynthio.ai", role: "Parent brand / trading engine", status: "active" },
  app/[locale]/page.tsx:325:  { domain: "coreintent.dev", role: "Dev hub / this site", status: "active" },
...
- PASS: HTML lang attribute set (dynamic per locale)
