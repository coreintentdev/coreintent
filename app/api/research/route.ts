...
export async function GET(req: NextRequest) {
  ...
  try {
    const { grok, claude, perplexity, allLive, allValid } = await callAllAIs({
      ...
      systems: {
        claude: "You are CoreIntent's self-awareness module. Be precise, honest, and direct. Reason step by step before stating conclusions.",
      },
    });
...
export async function POST(req: NextRequest) {
  ...
  try {
    type TaskFn = () => ReturnType<typeof callPerplexity | typeof callClaudeOpus | typeof callGrok>;
