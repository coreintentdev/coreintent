...
const INCIDENTS: Incident[] = [
  ...
  },
  {
    ...
    status: "resolved",
    severity: "info",
    message: "Positive incident: response structure improved with direct, actionable outputs. Keep this as the default human support mode unless explicitly overridden.",
    autoUpdate: true,
