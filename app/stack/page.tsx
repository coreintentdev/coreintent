...
const EXCHANGES = [
  { name: "Binance", status: "connected", pairs: "500+", type: "CEX" },
  { name: "Coinbase", status: "connected", pairs: "200+", type: "CEX" },
  { name: "gTrade", status: "pending", pairs: "50+", type: "DeFi (Polygon/Arbitrum)" },
];

export default function StackPage() {
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg-primary)", padding: "48px 24px", fontFamily: "inherit" }}>
            ...
            >
              <span
                style={{
                  ...
                  height: "10px",
                  borderRadius: "50%",
                  background: ex.status === "connected" ? "#10b981" : "#f59e0b",
                }}
              />
              <div>
