        ...
        >
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", alignItems: "center" }}>
            ...
            <input
              ...
              spellCheck={false}
              placeholder={typing ? "" : demoPhase >= 2 ? t("miniTerminal.yourTurn") : ""}
              style={{
          ...
          <div style={{ maxWidth: "800px", margin: "0 auto", position: "relative", zIndex: 1 }}>
            ...
            >
              <span className="sr-only">
                CoreIntent — {t("hero.title1")} {t("hero.titleHighlight")}. {t("hero.title2")} {t("hero.titleTruth")}.
              </span>
              <span aria-hidden="true">
                {t("hero.title1")}{" "}
                <span className="neon-green shimmer-text" style={{ position: "relative" }}>{t("hero.titleHighlight")}</span>.
                <br />
                {t("hero.title2")}{" "}
                <span style={{ color: "#f59e0b" }}>{t("hero.titleTruth")}</span>.
                <br />
                <span style={{ fontSize: "clamp(16px, 2.2vw, 24px)", color: "var(--text-secondary)", fontWeight: "normal", display: "block", marginTop: "12px" }}>
                  {t("hero.subtitle")}
                  <br />
                  <span style={{ color: "var(--accent-green)" }}>{t("hero.subtitleHighlight")}</span> {t("hero.subtitleEnd")}
                </span>
              </span>
            </h1>
            <div
