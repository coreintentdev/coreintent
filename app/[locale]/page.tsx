...
function LiveSignalFeed() {
  ...
  return (
    ...
    >
      ...
      <span style={{ color: "var(--text-secondary)", fontSize: "10px" }}>{t("common.demo")}</span>
    </div>
  );
}
      ...
      {showHero && (
        ...
        >
          ...
          <div style={{ maxWidth: "800px", margin: "0 auto", position: "relative", zIndex: 1 }}>
            ...
            >
              {[
                { label: t("hero.prop.models.title"), desc: t("hero.prop.models.desc"), color: "#a855f7" },
                { label: t("hero.prop.compete.title"), desc: t("hero.prop.compete.desc"), color: "#10b981" },
                { label: t("hero.prop.bots.title"), desc: t("hero.prop.bots.desc"), color: "#3b82f6" },
                { label: t("hero.prop.cost.title"), desc: t("hero.prop.cost.desc"), color: "#f59e0b" },
              ].map((prop) => (
                <div
                  key={prop.label}
            ...
            >
              {[
                { value: "3", label: t("stats.models"), color: "#a855f7" },
                { value: "6", label: t("stats.agents"), color: "#3b82f6" },
                { value: "$0", label: t("stats.entry_fee"), color: "#10b981" },
                { value: "$45/mo", label: t("stats.stack_cost"), color: "#f59e0b" },
