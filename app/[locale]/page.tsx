          ...
          <div style={{ maxWidth: "800px", margin: "0 auto", position: "relative", zIndex: 1 }}>
            ...
            <div style={{ marginTop: "36px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0", flexWrap: "wrap" }}>
                {[
                  { step: "1", label: t("pipeline.step1.label"), desc: t("pipeline.step1.desc"), color: "#ef4444" },
                  { step: "2", label: t("pipeline.step2.label"), desc: t("pipeline.step2.desc"), color: "#a855f7" },
                  { step: "3", label: t("pipeline.step3.label"), desc: t("pipeline.step3.desc"), color: "#3b82f6" },
                  { step: "4", label: t("pipeline.step4.label"), desc: t("pipeline.step4.desc"), color: "#10b981" },
                ].map((s, i) => (
