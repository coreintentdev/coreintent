  ...
  return (
    <div ref={ref} style={{ textAlign: "center", minWidth: "100px" }}>
      <div className="counter-value" style={{ fontSize: "clamp(28px, 4vw, 42px)", fontWeight: "bold", color, lineHeight: 1.1 }}>
        {prefix}{started ? count.toLocaleString(locale) : "0"}{suffix}
      </div>
          ...
          <div style={{ maxWidth: "800px", margin: "0 auto", position: "relative", zIndex: 1 }}>
            ...
            >
              <span className="sr-only">
                CoreIntent — {t("hero.heading1")} {t("hero.headingHighlight")}.
              </span>
              <span aria-hidden="true">
                {t("hero.heading1")}{" "}
                <span className="neon-green shimmer-text" style={{ position: "relative" }}>{t("hero.headingHighlight")}</span>.
                <br />
                {t("hero.heading2")}{" "}
                <span style={{ color: "#f59e0b" }}>{t("hero.headingTruth")}</span>.
                <br />
                <span style={{ fontSize: "clamp(16px, 2.2vw, 24px)", color: "var(--text-secondary)", fontWeight: "normal", display: "block", marginTop: "12px" }}>
                  {t("hero.subheading")}
                  <br />
                  <span style={{ color: "var(--accent-green)" }}>{t("hero.consensus")}</span> {t("hero.free")}
                </span>
              </span>
            </h1>
            <div
            ...
            >
              {t("hero.pitch")}{" "}
              <span style={{ color: "#ef4444", textDecoration: "line-through", opacity: 0.6 }}>{t("hero.pitchStrike")}</span>.
              {" "}{t("hero.pitchWePit")}{" "}
              <span style={{ color: "#ef4444", fontWeight: "bold" }}>Grok</span>,{" "}
              <span style={{ color: "#a855f7", fontWeight: "bold" }}>Claude</span>, &amp;{" "}
              <span style={{ color: "#3b82f6", fontWeight: "bold" }}>Perplexity</span> {t("hero.pitchAgainstEach")}
              {" "}{t("hero.pitchDisagree")}{" "}
              <span style={{ color: "var(--accent-green)", fontWeight: "bold" }}>{t("hero.pitchConviction")}</span>
            </p>
            <div style={{
              display: "flex",
              alignItems: "center",
