...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      inLanguage: ["en-NZ", "es-419", "mi-NZ", "zh-CN", "ja-JP", "pt-BR", "fr-FR", "de-DE", "ar-SA", "hi-IN"],
    ...
    },
    {
      ...
      hasPart: [
        { "@type": "WebPage", name: "Terminal", url: "https://coreintent.dev/en" },
        { "@type": "WebPage", name: "Demo", url: "https://coreintent.dev/en/demo" },
        { "@type": "WebPage", name: "Stack", url: "https://coreintent.dev/en/stack" },
        { "@type": "WebPage", name: "Competitions", url: "https://coreintent.dev/en/pricing" },
        { "@type": "WebPage", name: "Privacy Policy", url: "https://coreintent.dev/en/privacy" },
        { "@type": "WebPage", name: "Terms of Service", url: "https://coreintent.dev/en/terms" },
        { "@type": "WebPage", name: "Disclaimer", url: "https://coreintent.dev/en/disclaimer" },
      ],
    },
  ],
};
